...
V3f.UIElements.Draggable = function(title, width){
    ...
    var closeBtn = crel('button', {class:'UIDCloseButton'}, 'Close');
...
V3f.UIElements.Draggable.prototype = Object.assign(Object.create(V3f.UIElements.Element.prototype), {
    constructor: V3f.UIElements.Draggable,
